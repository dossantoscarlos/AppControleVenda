...
use App\Filament\Resources\Vendedors\Pages\ViewVendedor;
use App\Filament\Resources\Vendedors\Schemas\VendedorForm;
use App\Filament\Resources\Vendedors\Schemas\VendedorInfolist;
...
class VendedorResource extends Resource
{
    ...
    {
        return VendedorInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewVendedor::route('/{record}'),
